...
<head>
	<meta charset="UTF-8">
	<title>微博用户搜索 - airpur - 新浪微博</title>
	<link rel="shortcut icon" href="<?php echo base_url('assets/images/favicon .ico') ?>">
	<link rel="stylesheet" href="<?php echo base_url('assets/css/reset.css') ?>">
	<link rel="stylesheet" href="<?php echo base_url('assets/css/style.css') ?>">
	<script src="<?php echo base_url('assets/js/jquery-1.8.2.min.js') ?>"></script>
</head>
<body class="body_index" id="body_search">
	<div class="miniblog">
						...
						<div class="result_list">
							<div class="item clearfix">
								...
								<div class="detail">
									...
									<div class="operate">
										<img src="http://img.t.sinajs.cn/t4/style/images/common/transparent.gif" alt="" class="icon_connect">
										<p><a target="_blank" href="#" ><span class="search_icon searchper_icon"></span>TA的好友</a></p>
									</div>
								</div>
							</div>
							<div class="item clearfix">
								<div class="avatar left"> <img src="assets/images/7.jpg" width="50" height="50" alt=""></div>
								<div class="detail">
									<div class="info">
