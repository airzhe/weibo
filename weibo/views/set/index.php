...
<head>
	<meta charset="UTF-8">
	<title>个人信息 新浪微博-随时随地分享身边的新鲜事儿</title>
			...
			<div class="container main">
				<div class="content clearfix">
					<div class="left_nav left">
						...
						<div class="level_Box">
							<div class="lev"><a href="" class="curr"><i class="W_ico20 ico_personinfo"></i>个人信息</a></div>
							<div class="lev"><a href=""><i class="W_ico20 ico_avater"></i>头像</a></div>
								...
								<div class="item">
									...
									<div class="acc_form hide">
										...
										<div class="info_item clearfix">
											...
											<div class="inp"><input type="text" name="truename"></div>
