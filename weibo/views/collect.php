<div class="content clearfix">
	...
	<div class="main clearfix">
		<div class="box_center left">
			<div class="title">我的收藏<span class="num">（共<?php if (isset($weibo_list)) echo count($weibo_list); else echo 0; ?>条）</span></div>
