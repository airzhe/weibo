...
<div class="left_nav left">
	...
	<div class="level_Box">
		<div class="lev"><a href="" class="disable"><i class="W_ico20 ico_account ico_privacy"></i>隐私设置</a></div>
		<div class="lev"><a href="" class="disable"><i class="W_ico20 ico_account ico_message"></i>消息设置</a></div>
		<div class="lev"><a href="" class="disable"><i class="W_ico20 ico_account ico_prefer"></i>偏好设置</a></div>
	</div>
</div>