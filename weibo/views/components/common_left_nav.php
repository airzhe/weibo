...
<div class="left_nav left">
	<ul>
		...
		<li>
			...
			<ul>
				...
				<li><a href="<?php echo site_url('praise') ?>" data-type="praise"><i class="W_ico20 ico_lev_like"></i>赞</a></li>
				<li><a href="<?php echo site_url('letter') ?>" data-type="letter"><i class="W_ico20 ico_lev_letter"></i>私信</a></li>
	...
	<ul class="goodfriend">
		<li><a href="" class="disable"><i class="W_ico20 ico_goodfriend"></i>好友圈</a></li>
		<li></li>
	</ul>
	<div class="group">
		<fieldset>
			<legend class="S_txt2 disable">分组</legend>
		</fieldset>
		<ul>
			<li><a href="#" class="disable"><i class="W_ico20 ico_group"></i>同事</a></li>
			<li><a href="#" class="disable"><i class="W_ico20 ico_group"></i>同学</a></li>
			<li><a href="#" class="disable"><i class="W_ico20 ico_group"></i>朋友</a></li>
			<li><a href="#" class="disable"><i class="W_ico20 ico_group"></i>家人</a></li>
			<li><a href="#" class="disable"><i class="W_ico20 ico_group"></i>明星</a></li>
		</ul>
	</div>
</div>