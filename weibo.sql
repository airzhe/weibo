...
CREATE TABLE IF NOT EXISTS `t_comment` (
  ...
  KEY `wid` (`wid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='评论表' AUTO_INCREMENT=69 ;

--
-- 转存表中的数据 `t_comment`
--

INSERT INTO `t_comment` (`id`, `uid`, `content`, `isreplay`, `time`, `wid`) VALUES
(44, 10001, '我来给你加条评论！[挤眼]', 0, 1392994436, 68),
(39, 10000, '[吃惊][委屈]', 0, 1392989538, 68),
(38, 10000, '[笑哈哈]', 0, 1392989366, 68),
(37, 10000, 'zv', 0, 1392989198, 68),
(68, 10000, '[笑哈哈]', 0, 1393061926, 100),
(34, 10000, '呵呵呵', 0, 1392974697, 68),
(60, 10000, '[moc转发]', 0, 1393043542, 68),
(59, 10000, '回复:@runner[青啤鸿运当头]', 58, 1393043524, 68),
(28, 10000, 'a发', 0, 1392971797, 68),
(58, 10000, '回复:@runner opppppp', 57, 1393043475, 68),
(23, 10000, '[给力]', 0, 1392970779, 68),
(24, 10000, '这是一段很给给力的评论[害羞]', 0, 1392970825, 68),
(56, 10000, '回复:@purple', 46, 1393043191, 68),
(57, 10000, '回复:@purple[笑哈哈]', 44, 1393043232, 68),
(22, 10000, '回复:@地瓜哥text', 1000, 1392969098, 68),
(21, 10000, 'textet', 0, 1392969092, 68),
(45, 10000, ' 给你来条', 0, 1392994601, 66),
(46, 10001, '再来个？', 0, 1392994810, 68),
(47, 10001, '呵呵', 0, 1392994829, 68);
...
('3306ab322c9beedcafe4d02572ce71dd', '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.107 Safari/537.36', 1393080038, 'a:6:{s:9:"user_data";s:0:"";s:3:"uid";s:5:"10000";s:7:"account";s:16:"532499602@qq.com";s:8:"username";s:6:"runner";s:6:"avatar";s:24:"201402/1392728074371.jpg";s:8:"loggedin";b:1;}'),
('f501a93278f175ecb8220dfac3ace2ce', '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:27.0) Gecko/20100101 Firefox/27.0', 1393079943, 'a:6:{s:9:"user_data";s:0:"";s:3:"uid";s:5:"10001";s:7:"account";s:15:"air_zhe@163.com";s:8:"username";s:6:"purple";s:6:"avatar";s:24:"201402/1392728140354.jpg";s:8:"loggedin";b:1;}');
...
(1, 'runner', '魏浩哲', 'a:2:{i:0;s:6:"河南";i:1;s:6:"郑州";}', '1999-01-01', '男', '生活因找到而快乐。', '201402/1392728074371.jpg', 'runner', 'a:4:{s:8:"template";s:1:"4";s:5:"cover";s:5:"3.jpg";s:4:"suit";s:1:"7";s:5:"style";s:5:"4.css";}', 2, 2, 26, 10000),
(6, 'purple', '', 'a:2:{i:0;s:6:"浙江";i:1;s:6:"杭州";}', '1998-01-01', '女', '', '201402/1392728140354.jpg', 'purple', 'a:2:{s:4:"suit";s:1:"6";s:5:"style";s:5:"1.css";}', 1, 1, 13, 10001),
...
CREATE TABLE IF NOT EXISTS `t_weibo` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='微博表' AUTO_INCREMENT=133 ;
...
(66, '[互粉]', 0, 0, 1392384130, 0, 0, 0, 1, 10000),
(68, '[ali哇][奥特曼]', 0, 0, 1392384203, 0, 0, 0, 14, 10000),
(71, '背景…下雨天，公司公共厕所。1号蹲位的哥们问2号：“今天下雨了，是不是不回家吃饭了？就在这吃吧？”2号一直没动静，1号又重复说了遍。突然4号冒出一句：“如果在这吃，我就不冲水了啊！”哇哈哈…弄得哥在3号都笑出尿了…(转)[笑哈哈]', 0, 0, 1393049790, 0, 1, 0, 0, 10000),
(73, '[围观]', 0, 0, 1393054489, 0, 0, 0, 0, 10000),
(74, '[挖鼻屎]', 0, 0, 1393054614, 0, 0, 0, 0, 10000),
(75, '[熊猫]', 0, 0, 1393054657, 0, 0, 0, 0, 10000),
(132, '哈哈，挺好笑的。[挤眼]', 71, 0, 1393080129, 0, 0, 0, 0, 10001),
