...
CREATE TABLE IF NOT EXISTS `t_comment` (
  ...
  KEY `wid` (`wid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='评论表' AUTO_INCREMENT=139 ;
...
CREATE TABLE IF NOT EXISTS `t_letter` (
  ...
  PRIMARY KEY (`id`,`uid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='私信表' AUTO_INCREMENT=20 ;
...
CREATE TABLE IF NOT EXISTS `t_picture` (
  ...
  PRIMARY KEY (`id`),
  KEY `wid` (`wid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='微博配图' AUTO_INCREMENT=83 ;
...
('6ad17f113c71f2d3768fd6c86e4598b8', '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.107 Safari/537.36', 1393755716, 'a:7:{s:9:"user_data";s:0:"";s:3:"uid";s:5:"10000";s:7:"account";s:16:"532499602@qq.com";s:8:"username";s:6:"runner";s:3:"sex";s:3:"男";s:6:"avatar";s:24:"201402/1393256000690.jpg";s:8:"loggedin";b:1;}'),
('8a865ffd3679a2b535ff05c8f64ea8a2', '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.107 Safari/537.36', 1393755762, 'a:7:{s:9:"user_data";s:0:"";s:3:"uid";s:5:"10001";s:7:"account";s:15:"air_zhe@163.com";s:8:"username";s:6:"purple";s:3:"sex";s:3:"女";s:6:"avatar";s:24:"201402/1392728140354.jpg";s:8:"loggedin";b:1;}');
...
(1, 'runner', '魏浩哲', 'a:2:{i:0;s:6:"河南";i:1;s:6:"郑州";}', '1999-01-01', '男', '生活因找到而快乐。', '201402/1393256000690.jpg', 'runner', 'a:4:{s:8:"template";s:1:"4";s:5:"cover";s:5:"3.jpg";s:4:"suit";s:1:"7";s:5:"style";s:5:"5.css";}', 2, 1, 17, 10000),
(6, 'purple', '', 'a:2:{i:0;s:6:"浙江";i:1;s:6:"杭州";}', '1998-01-01', '女', '', '201402/1392728140354.jpg', 'purple', 'a:2:{s:4:"suit";s:1:"6";s:5:"style";s:5:"1.css";}', 1, 1, 14, 10001),
(8, '敏敏', '', 'a:2:{i:0;s:6:"湖北";i:1;s:6:"天门";}', '2015-02-01', '女', '', '', NULL, '0', 0, 1, 7, 10004),
...
CREATE TABLE IF NOT EXISTS `t_weibo` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='微博表' AUTO_INCREMENT=341 ;
...
(187, '@purple 真是美好的一天啊。', 0, 0, 0, 1393647833, 0, 0, 0, 1, 10000),
(340, '来自星星的你。', 1, 0, 0, 1393752941, 0, 0, 0, 0, 10001);
